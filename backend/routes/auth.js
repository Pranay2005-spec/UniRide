...
router.post('/setup-rider', upload.fields([{ name: 'licensePhoto', maxCount: 1 }]), authController.setupRiderAccount);
router.post('/create-rider', authController.setupRiderAccount);
router.post('/apply-rider', auth, upload.fields([{ name: 'licensePhoto', maxCount: 1 }]), authController.applyRider);
